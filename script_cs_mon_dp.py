...
from cs_mon_mxlMonMcmc import estimate, ppdB, ppdW
...
xRnd = np.stack((ASC_rs, cost), axis = 1)
xRnd_trans = np.array([0, 1])

xRnd2 = np.stack((ovtt, ivtt, ivtt_pool, electric, automation), axis = 1)
